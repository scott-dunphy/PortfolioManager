...
class Portfolio:
  ...
  def aggregate_hold_period_cash_flows(self) -> pd.DataFrame:
      ...
      for property in self.properties:
          ...
          aggregate_cf [['Adjusted Purchase Price','Adjusted Loan Proceeds','Adjusted Net Operating Income','Adjusted Capital Expenditures','Adjusted Interest Expense','Adjusted Principal Payments','Adjusted Debt Scheduled Repayment','Adjusted Debt Early Prepayment','Adjusted Sale Proceeds','Adjusted Partner Buyout']]
